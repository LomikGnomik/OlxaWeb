...
namespace OlxaWeb.WebUI.Infrastructure
{
    public class NinjectDependencyResolver : IDependencyResolver
    {
        ...
        private void AddBindings()
        {
            ...
            //new Temmplate {Title="Строительный",Description="", Category="Интернет-магазин", ShortDescription="", LinkDemo="", LinkPicture="product-bg01.jpg", Price=100500 , Id=1 , Publish=true},
