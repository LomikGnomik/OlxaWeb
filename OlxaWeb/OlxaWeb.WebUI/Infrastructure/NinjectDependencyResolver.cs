...
namespace OlxaWeb.WebUI.Infrastructure
{
    public class NinjectDependencyResolver : IDependencyResolver
    {
        ...
        private void AddBindings()
        {
            ...
            new Post {Id=6,Title="",ShortDescription="",Description="",Meta="",UrlSlug="1478172823164455436.png",Published=true,Category="SEO",PostedOn=DateTime.Today, Modified=DateTime.Now },
