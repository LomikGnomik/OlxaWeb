...
namespace OlxaWeb.WebUI.Infrastructure
{
    public class NinjectDependencyResolver : IDependencyResolver
    {
        ...
        private void AddBindings()
        {
            ...
            new Post {Id=3,Title="",ShortDescription="",Description="",Meta="",UrlSlug="image.jpg",Published=true,Category="О всяком",PostedOn=DateTime.Today, Modified=DateTime.Now,Counter=200 },
